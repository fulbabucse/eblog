...
const BlogDetails = () => {
  return (
    <div class="max-w-screen-xl mx-auto">
      <main class="mt-10">
        <div class="mb-4 md:mb-0 w-full mx-auto relative px-4 lg:px-0">
          <img
            ...
            alt=""
          />
          <div class="lg:absolute lg:-bottom-10 bg-white lg:w-5/6 py-5">
        ...
        <div class="flex flex-col lg:flex-row lg:space-x-12">
          <div class="px-4 lg:px-0 lg:mt-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
            <p class="pb-6">
          ...
          <div class="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
            <div class="p-4 border-t border-b md:border md:rounded">
              <div class="flex py-2">
                ...
                />
                <div>
                  <p class="font-semibold text-gray-700 text-sm">Fahim Islam</p>
              ...
              <button class="px-2 py-1 text-gray-100 bg-slate-700 flex w-full items-center justify-center rounded">
                Follow
